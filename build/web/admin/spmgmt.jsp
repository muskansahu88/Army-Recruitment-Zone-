        ...
        <div class="container">
            ...
            <div class="row mt-2">                
                <div class="col-sm-12" style="min-height:600px;background-color: whitesmoke">                    
                    <h2 style="text-align: center;">Add Sample Papers</h2>
                    <form class="form-group" method="post" action="../AddSp" enctype="multipart/form-data">
                        <table class="table" style="margin: auto;width:60%;">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <button type="submit" class="btn btn-success">Add Sample Paper</button>
                                </td>
                            </tr>
                        </table>
                    </form>
